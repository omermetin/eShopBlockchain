...
// const network = 'eshop-network';
// const adminID = 'admin';
// const adminPW = 'adminpw';
const _timeout = 90000;
const NS = 'org.eshop';
const orderNo = '12345';
const buyerID = 'omer@email.com';
const sellerID = 'mimar@email.com';
...
* @param {vendor_type} _string - type of vendor to (e.g. 'supplier', 'shipper', etc.)
...
describe('Finance Network', function () {
    ...
    before(function () {
        ...
        return businessNetworkConnection.connect('admin@eshop-network');
    });
/* describe('Finance Network', () => {
    ...
    describe('#issueCancel', () => {
        ...
        it('should be able to record an order cancellation', () => {
            ...
            // create the Deliver transaction
            const orderNow = factory.newTransaction(NS, 'Cancelled'); //OrderCancel instead of Order
