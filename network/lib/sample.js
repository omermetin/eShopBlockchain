 ...
 * @param {org.eshop.CreateOrder} purchase - the order to be processed
 * @transaction
 */
 function CreateOrder(purchase) {
    ...
    return getAssetRegistry('org.eshop.Order')
 ...
 * @param {org.eshop.Buy} purchase - the order to be processed
 * @transaction
 */
 ...
 * @param {org.eshop.OrderCancel} purchase - the order to be processed
 * @transaction
 */
 ...
 * @param {org.eshop.OrderFromSupplier} purchase - the order to be processed
 * @transaction
 */
 ...
 * @param {org.eshop.RequestShipping} purchase - the order to be processed
 * @transaction
 */
 ...
 * @param {org.eshop.Delivering} purchase - the order to be processed
 * @transaction
 */
...
/**
 * Record a delivery by shipper
 * @param {org.eshop.Deliver} purchase - the order to be processed
 * @transaction
 */
 ...
 * @param {org.eshop.RequestPayment} purchase - the order to be processed
 * @transaction
 */
 ...
 * @param {org.eshop.Pay} purchase - the order to be processed
 * @transaction
 */
 ...
 * @param {org.eshop.Dispute} purchase - the order to be processed
 * @transaction
 */
 ...
 * @param {org.eshop.Resolve} purchase - the order to be processed
 * @transaction
 */
 ...
 * @param {org.eshop.Refund} purchase - the order to be processed
 * @transaction
 */
 ...
 * @param {org.eshop.BackOrder} purchase - the order to be processed
 * @transaction
 */
