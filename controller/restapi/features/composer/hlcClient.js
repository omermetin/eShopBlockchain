...
const NS = 'org.eshop';
let itemTable = null;
const svc = require('./eshop_Services');
...
exports.getMyOrders = function (req, res, next) {
    ...
    let ser;
    let archiveFile = fs.readFileSync(path.join(path.dirname(require.main.filename),'network','dist','eshop-network.bna'));
...
*/
exports.init_eshopEvents = function (req, res, next)
{
    let method = 'init_eshopEvents';
